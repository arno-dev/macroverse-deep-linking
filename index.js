...
var assetLinksContents = fs.readFileSync(path.resolve(__dirname, './assets/assetlinks.json'), 'utf8');
...
app.get(['/assetlinks.json', '/.well-known/assetlinks.json'], function (req, res) {
    res.set('Content-Type', 'application/json');
    res.send(assetLinksContents);
});
